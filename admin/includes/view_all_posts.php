...
echo "<td><img width='130' class='img-responsive' src='../images/$post_image' alt='image'></td>";
...
echo "<td><a class='btn btn-success' href='../post.php?p_id={$post_id}'>View Post</td>";
echo "<td><a class='btn btn-info' href='posts.php?source=edit_post&p_id={$post_id}'>Edit</td>";
//    echo "<td><a onClick=\"javascript: return confirm('Are u sure u want to delete this post!'); \" href='posts.php?delete={$post_id}'>Delete</td>";
